...
# Configuration
# BASE_URL takes priority; SANDBOX_BASE_URL is accepted so the same variable
# used by the Python SDK works here too.
BASE_URL="${BASE_URL:-${SANDBOX_BASE_URL:-http://localhost:8080}}"
