...
class TestJobResult:
    ...
    def test_succeeded_is_complete(self):
        result = JobResult({
            "job_id": "j1", "sandbox_id": "s1", "command": "echo hi",
            "status": "succeeded", "exit_code": 0, "stdout": "hi\n",
            "created_at": 1.0,
        })
    ...
    def test_failed_is_complete(self):
        result = JobResult({
            "job_id": "j1", "sandbox_id": "s1", "command": "false",
    ...
    def test_running_is_not_complete(self):
        result = JobResult({
            "job_id": "j1", "sandbox_id": "s1", "command": "sleep 999",
            "status": "running",
            "created_at": 1.0,
        })
